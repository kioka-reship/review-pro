        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "40px 20px" }}>
          <div style={{ background: "#fff", borderRadius: "16px", padding: "40px", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
            ...
            {[
              ...
              {
                title: "第6条（解約）",
                content: "契約者はマイページから解約申請を行うことができます。申請月の料金は返金しません。①月契約の場合、解約申請の翌月末をもってサービスを停止します。解約金は発生しません。②年契約の場合、解約申請の翌月末をもってサービスを停止します。残月数（契約開始から12ヶ月の終了予定日から申請翌月末までの月数）×年契約月額100%相当を解約金として申請時に自動請求します。解約後90日間はデータを保持しますが、その後削除します。"
              },
              {
                title: "第7条（禁止事項）",
